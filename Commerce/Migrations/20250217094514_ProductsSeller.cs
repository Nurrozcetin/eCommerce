...
{
    /// <inheritdoc />
    public partial class ProductsSeller : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductFavouritesID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FavouritesID = table.Column<int>(type: "int", nullable: false),
                    ProductID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductFavourites", x => x.ProductFavouritesID);
                    table.ForeignKey(
                        name: "FK_ProductFavourites_Favourites_FavouritesID",
                        column: x => x.FavouritesID,
                        principalTable: "Favourites",
                        principalColumn: "FavouritesID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductFavourites_Product_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Product",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_CategoriesCategoryID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFavourites_FavouritesID",
                table: "ProductFavourites",
                column: "FavouritesID");

            migrationBuilder.CreateIndex(
                name: "IX_ProductFavourites_ProductID",
                table: "ProductFavourites",
                column: "ProductID");
